    ...
    <template v-else>
      ...
      <div class="dp--month-year-wrap">
        ...
        <div
          ...
          :class="{
            'dp--year-disable-select': rootProps.disableYearSelect,
          }"
        >
...
<script lang="ts" setup>
  ...
  import { CalendarIcon, ChevronDownIcon, ChevronLeftIcon, ChevronRightIcon, ChevronUpIcon } from '@/components/Icons';
